...
trainData = instance_matrix(trainIndex==1,:);
trainLabel = label_vector(trainIndex==1,:);
testData = instance_matrix(testIndex==1,:);
testLabel = label_vector(testIndex==1,:);
